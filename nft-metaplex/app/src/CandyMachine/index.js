  ...
  const getCandyMachineState = async() => {
    ...
    const presale = candyMachine.data.whitelistMintSettings && 
      ...
      (!candyMachine.data.goLiveDate || 
        candyMachine.data.goLiveDate.toNumber() > new Date().getMinutes() / 1000);

    //setCandyMachine(candyMachine);

    // to make it easier to access data later
    setCandyMachine({
    ...
    const goLiveDateTimeString = `${new Date(goLiveDate * 1000).toLocaleString()}`;
